...
<template>
  <div v-if="props.messageId" class="user-chat w-100 overflow-hidden">
    <div class="d-lg-flex">
                ...
                <div class="user-chat-content">
                  <div class="ctext-wrap">
                    <div class="ctext-wrap-content">
                      ...
                      <p class="chat-time mb-0"><i class="ri-time-line align-middle"></i> <span class="align-middle">{{ formatDate(message.created_at) }}</span></p>
                    </div>
...
<!--            </li>-->
  ...
  <div v-else style="margin: auto auto;display: block; ">
    <p >
    Chưa chọn tin nhắn
  </p></div>
</template>
