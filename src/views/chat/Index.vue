      ...
      <ul class="nav nav-pills side-menu-nav justify-content-center" role="tablist">
        ...
        <li class="nav-item dropdown profile-user-dropdown d-inline-block d-lg-none">
          ...
          <div class="dropdown-menu">
            ...
            <a class="dropdown-item" @click="logout">Log out <i class="ri-logout-circle-r-line float-end text-muted"></i></a>
          </div>
        </li>
      </ul>
    </div>
          ...
          <div class="p-4">
            ...
            <div class="search-box chat-search-box">
              <div class="input-group bg-light  input-group-lg rounded-3">
                ...
                <input @input="searchUserByQuery" v-model="searchQuery" type="text" class="form-control bg-light" placeholder="Search users..">
              </div>
            </div>
            <!-- End search-box -->
          </div>
...
<script setup>
import MessageDetail from "@/views/chat/MessageDetail.vue";
